        ...
        try {
            ...
            if (
                ...
                Toast.show({
                    type: 'error',
                    text1: 'Invalid JSON',
                    text2: 'Please ensure the JSON array contains valid question objects with "question", "correctOption", "points", and "duration".',
                });
                return;
            }
            ...
            Toast.show({
                ...
                text2: `${questionsWithIds.length} question(s) added successfully.`,
            });
        } catch (error) {
            Toast.show({
                type: 'error',
